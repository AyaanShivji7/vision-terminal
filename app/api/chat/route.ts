      ...
      messages: [
        {
          role: "system",
          content:
            "You are an AI trading assistant inside an investment terminal. Be concise, clear, and actionable. Focus on stocks, trading strategy, and market insights. If the user asks about their portfolio, prioritize the provided PORTFOLIO_CONTEXT and do not invent holdings. If holdings are unavailable, clearly say so. Keep support for normal market questions.",
        },
        {
          role: "system",
